...
{
    public class Student14YearsEducation
    {
        #region Fields & Properties
        public int Student14YearEduId { get; set; }
        ...
        #region  Insert Student 14 Year Education Information With Transaction
        public bool InsertStudent14YearEducation(SqlTransaction sqltrans)
        {
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(sqltrans, CommandType.StoredProcedure, "InsertStudent14YearEducation", sqlparams).ToString();
            }
            catch
            {
                return false;
        ...
        #region  Update Student 14 Year Education Information With Transaction
        public bool UpdateStudent14YearEducation(SqlTransaction sqltrans)
        {
            try
            {
                SqlParameter[] sqlparams = new SqlParameter[15];
                ...
                sqlparams[14] = new SqlParameter("@ResultAwaitingSeatNo", ResultAwaitingSeatNo);
                string conn = ConfigurationManager.ConnectionStrings["SMIUConnection"].ConnectionString;
                SqlHelper.ExecuteNonQuery(sqltrans, CommandType.StoredProcedure, "UpdateStudent14YearEducation", sqlparams).ToString();
            }
            catch
            {
                return false;
        ...
        #region  Delete Student14 Year Education Information With Transaction
        public bool DeleteStudent14YearEducation(SqlTransaction sqltrans)
        {
            try
            {
                ...
                sqlparams[0] = new SqlParameter("@StudentID", StudentId);
                string conn = ConfigurationManager.ConnectionStrings["SMIUConnection"].ConnectionString;
                SqlHelper.ExecuteNonQuery(sqltrans, CommandType.StoredProcedure, "DeleteStudent14YearEducation", sqlparams).ToString();
            }
            catch
            {
                return false;
