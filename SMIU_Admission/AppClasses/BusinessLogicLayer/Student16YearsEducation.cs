...
{
    public class Student16YearsEducation
    {
        #region Fields & Properties
        public int Student16YearEduId { get; set; }
        ...
        #region  Insert Student 16 Year Education Information With Transaction
        public bool InsertStudent16YearEducation(SqlTransaction sqltrans)
        {
            try
            {
                ...
                //sqlparams[2] = new SqlParameter("@PassingYear", PassingYear);
                ...
                SqlHelper.ExecuteNonQuery(sqltrans, CommandType.StoredProcedure, "InsertStudent16YearEducation", sqlparams).ToString();
            }
            catch
            {
                return false;
        ...
        #region  Update Student 16 Year Education Information With Transaction
        public bool UpdateStudent16YearEducation(SqlTransaction sqltrans)
        {
            try
            {
                SqlParameter[] sqlparams = new SqlParameter[15];
               ...
               // sqlparams[2] = new SqlParameter("@PassingYear", PassingYear);
                ...
                sqlparams[14] = new SqlParameter("@ResultAwaitingSeatNo", ResultAwaitingSeatNo);   
                string conn = ConfigurationManager.ConnectionStrings["SMIUConnection"].ConnectionString;
                SqlHelper.ExecuteNonQuery(sqltrans, CommandType.StoredProcedure, "UpdateStudent16YearEducation", sqlparams).ToString();
            }
            catch
            {
                return false;
        ...
        #region  Delete Student16 Year Education Information With Transaction
        public bool DeleteStudent16YearEducation(SqlTransaction sqltrans)
        {
            try
            {
                ...
                sqlparams[0] = new SqlParameter("@StudentID", StudentId);
                string conn = ConfigurationManager.ConnectionStrings["SMIUConnection"].ConnectionString;
                SqlHelper.ExecuteNonQuery(sqltrans, CommandType.StoredProcedure, "DeleteStudent16YearEducation", sqlparams).ToString();
            }
            catch
            {
                return false;
