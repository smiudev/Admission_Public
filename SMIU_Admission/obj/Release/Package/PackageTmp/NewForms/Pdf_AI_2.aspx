<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pdf_AI_2.aspx.cs" Inherits="SMIU_Admission.NewForms.Pdf_AI_2"
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="cphbody">
    ...
    <%-- <div id="Enroll" runat="server" visible="false" style="overflow: Auto; max-height: 850px;
        ...
        <br />--%>
    <fieldset>
        <legend>Student 2nd Merit List Details</legend>
