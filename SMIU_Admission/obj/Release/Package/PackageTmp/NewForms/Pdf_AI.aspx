<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pdf_AI.aspx.cs" Inherits="SMIU_Admission.NewForms.Pdf_AI"
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="cphbody">
    ...
    <%-- <div id="Enroll" runat="server" visible="false" style="overflow: Auto; max-height: 850px;
        ...
        <br />--%>
    <fieldset>
        <legend runat="server" id="lblMeritListNumber">Student MERITLISTNUMBER Merit List Details</legend>
        <div id="ExportToExcel" runat="server">
            ...
            <table width="100%" border="1">
                <tr>
                    <td style="width: 50%; text-align: center;" colspan="14">
                        <strong>Student(s)List - Undergraduate</strong>
                        <br />
                    </td>
                </tr>
            </table>
            ...
            <br />
                ...
                <table width="100%" border="1">
                    <tr>
                        <td style="width: 50%; text-align: center;" colspan="14">
                            <strong>Student(s)List - Graduate </strong>
                            <br />
                        </td>
                    </tr>
                </table>
                <asp:GridView ID="grdGraduate" runat="server" AutoGenerateColumns="False" EmptyDataText="No Record Found"
                    DataKeyNames="StudentID">
                    <Columns>
                        <%--<asp:TemplateField HeaderText="S.No">
                        <ItemTemplate>
                        ...
                        <asp:BoundField DataField="StudentName" HeaderText="Student Name" />
                        <asp:BoundField DataField="ProgramName" HeaderText="Program" />
                        <%--<asp:BoundField DataField="Weightage" HeaderText="Weightage / cutoff" />--%>
                    </Columns>
                </asp:GridView>
                <br />
                <table width="100%" border="1">
                    <tr>
                        <td style="width: 50%; text-align: center;" colspan="14">
                            <strong>Student(s)List - Postgraduate </strong>
                            <br />
                        </td>
                    </tr>
                </table>
                <asp:GridView ID="grdPostgraduate" runat="server" AutoGenerateColumns="False" EmptyDataText="No Record Found"
                    DataKeyNames="StudentID">
                    <Columns>
<%--                        <asp:TemplateField HeaderText="S.No">
                            <ItemTemplate>
                ...
                <br />
            <div id="graduate" runat="server" visible="true">
                <table width="100%" border="1">
                    <tr>
                        <td style="width: 50%; text-align: center;" colspan="14">
                            <strong>Student(s)List - Self Finance </strong>
                            <br />
                        </td>
                    </tr>
                </table>
                <asp:GridView ID="grdStudentSelfFinance" Visible="true" runat="server" AutoGenerateColumns="False"
                    EmptyDataText="No Record Found" DataKeyNames="StudentID">
                    <Columns>
                        <%-- <asp:TemplateField HeaderText="S.No">
                        <ItemTemplate>
                            <%# Container.DataItemIndex + 1 %>
