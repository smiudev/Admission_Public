<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrientationAttendance.aspx.cs"
    Inherits="SMIU_Admission.Modules.Forms.OrientationAttendance" MaintainScrollPositionOnPostback="false"
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="cphTitle">
    <h1>
        Orientation Attendance -  <asp:Label ID="lblSemesterName" runat="server" Text="SemesterName"></asp:Label>
    </h1>
                ...
                <tr>
                    ...
                    <td class="style2">
                        <asp:TextBox ID="txtReferenceID" runat="server" ToolTip="Reference/Tracking ID" Width="150px"
                            MaxLength="15" ValidationGroup="EntryTestAttendance" autocomplete="off"></asp:TextBox>
