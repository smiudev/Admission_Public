<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageInterviewSchedule.aspx.cs"
    Inherits="SMIU_Admission.Modules.Forms.ManageInterviewSchedule" MasterPageFile="~/MasterPages/student.Master"
    ...
    <asp:UpdatePanel ID="UpdPnl" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <div id="Enroll" runat="server" visible="false" style="overflow: Auto; max-height: 450px;
                ...
                <br />
                <fieldset>
                    <legend>Student Interview Schedule</legend>
