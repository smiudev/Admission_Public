<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EntryTestInterviewAttendance.aspx.cs"
    Inherits="SMIU_Admission.Modules.Forms.EntryTestInterviewAttendance" MaintainScrollPositionOnPostback="false"
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="cphTitle">
    <h1>
        Entry Test Interview Attendance
    </h1>
</asp:Content>
                ...
                <tr>
                    ...
                    <td class="style2">
                        <asp:TextBox ID="txtReferenceID" runat="server" ToolTip="Reference/Tracking ID" Width="150px"
                            MaxLength="5" ValidationGroup="EntryTestAttendance" autocomplete="off"></asp:TextBox>
                ...
                <fieldset>
                    ...
                    <asp:GridView ID="gvManageStudentDetails" runat="server" EmptyDataText="No Record Found"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="ReceivingDate" HeaderText="Fee Receiving Date" ItemStyle-CssClass="CM"
