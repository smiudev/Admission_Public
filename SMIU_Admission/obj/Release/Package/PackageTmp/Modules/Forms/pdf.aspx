<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pdf.aspx.cs" Inherits="SMIU_Admission.Modules.Forms.pdf"
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="cphbody">
    ...
    <%-- <div id="Enroll" runat="server" visible="false" style="overflow: Auto; max-height: 850px;
        ...
        <br />--%>
    <fieldset>
        <legend>Student 3<sup>rd</sup> Merit List Details</legend>
        <div id="ExportToExcel" runat="server">
            ...
            <div id="graduate" runat="server">
                ...
                <asp:GridView ID="grdStudentSelfFinance" runat="server" AutoGenerateColumns="False"
