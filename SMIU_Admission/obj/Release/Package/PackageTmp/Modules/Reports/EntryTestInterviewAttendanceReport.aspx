<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EntryTestInterviewAttendanceReport.aspx.cs"
    Inherits="SMIU_Admission.Modules.Reports.EntryTestInterviewAttendanceReport"
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="cphTitle">
    <h1>
        Entry Test Interview Attendance Summary Report
    </h1>
    <br />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphbody" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <fieldset>
                <legend>Entry Test Interview Attendance Summary Report</legend>
                <br />
                <table class="tbl">
                 <tr>
                        <td>
                    ...
                    <table width="50%" border="1">
                        <tr>
                            <td colspan="21" style="text-align: center;">
                                <strong>Entry Test Interview Attendance Summary Report - <asp:Label ID="lblSemesterName" runat="server" Text="SemesterName"></asp:Label></strong><br />
                            </td>
                        </tr>
                    </table>
