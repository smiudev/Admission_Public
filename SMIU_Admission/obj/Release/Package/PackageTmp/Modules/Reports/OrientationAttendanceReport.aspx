<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrientationAttendanceReport.aspx.cs" Inherits="SMIU_Admission.Modules.Reports.OrientationAttendanceReport"
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="cphTitle">
    <h1>
        Department Wise Orientation Attendance Summary Report </h1>
    <br />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphbody" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <fieldset>
                <legend>Orientation Attendance Summary Report</legend>
                <br />
                <table class="tbl">
                 <tr>
                        <td>
            ...
            <fieldset id="MainReport" runat="server" visible="false">
                <legend>Department Wise Orientation Attendance Summary Report</legend>
                <br />
                    ...
                    <table width="50%" border="1">
                        <tr>
                            <td colspan="21" style="text-align: center;">
                                <strong>Department Wise Orientation Attendance Summary Report -  <asp:Label ID="lblSemesterName" runat="server" Text="SemesterName"></asp:Label></strong><br />
                            </td>
                        </tr>
                    </table>
