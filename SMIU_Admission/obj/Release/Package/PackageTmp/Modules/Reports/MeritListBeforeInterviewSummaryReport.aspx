<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MeritListBeforeInterviewSummaryReport.aspx.cs"
    Inherits="SMIU_Admission.Modules.Reports.MeritListBeforeInterviewSummaryReport"
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="cphTitle">
    <h1>
        Department Wise Entry Test Merit Summary Report Before Interview
    </h1>
    <br />
</asp:Content>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <fieldset id="MainReport" runat="server" visible="false">
                <legend>Department Wise Entry Test Merit Summary Report Before Interview </legend>
                <br />
                    ...
                    <table width="50%" border="1">
                        <tr>
                            <td colspan="21" style="text-align: center;">
                                <strong>Department Wise Entry Test Merit Summary Report Before Interview -  <asp:Label ID="lblSemesterName" runat="server" Text="SemesterName"></asp:Label></strong><br />
                            </td>
                        </tr>
                    </table>
